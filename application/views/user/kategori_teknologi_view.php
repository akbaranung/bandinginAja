        ...
        <div class="container">
            <div class="title-section-ourmenu t-center m-b-22">
                <h3 class="tit5 t-center m-t-2">
                    Kategori Product Teknologi
                </h3>
            </div>
            <form action="<?= base_url('Kategori_product/Teknologi') ?>" method="get">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <select class="custom-select" id="jenis" name="jenis">
                                <option value="">Pilih</option>
                                <?php foreach ($teknologi_jenis as $t) : ?>
                    ...
                    <div class="col-md-3 p-t-30">
                        <a href="<?= $t->url ?>">
                            <div class="card" style="white-space: nowrap;">
                                <div class="card wrap-pic-blo1 bo-rad-10 hov-img-zoom" style="border: 2px solid #1473e6 ;">
